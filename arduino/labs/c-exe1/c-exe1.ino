/* 1.
Afisati numerele de la 0 la 9999 pe display (la 1 nu se afiseaza 0001 ci doar 1). - 1pt
*/
...
const byte SEGMENT_MAP[] = {0xC0,0xF9,0xA4,0xB0,0x99,0x92,0x82,0xF8,0X80,0X90}; //mappingul segmentelor
//const byte SEGMENT_MAP[] = {0xC0,0xCF,0xA4,0x86,0x8B,0x92,0x90,0xC7,0X80,0x82};
/* Byte maps to select digit 1 to 4 */
const byte SEGMENT_SELECT[] = {0xF1,0xF2,0xF4,0xF8}; //mappingul ordinii cifrelor
